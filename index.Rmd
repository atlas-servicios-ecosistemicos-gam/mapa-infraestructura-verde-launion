---
title: "Mapa de infraestructura verde del cantón de La Unión"
output: 
...
url_raster_infraestructura_verde <-
  "https://raw.githubusercontent.com/atlas-servicios-ecosistemicos-gam/datos/master/infraestructura-verde/launion/IV_LA_UNION_WEB.TIF"
...
### Datos para descarga: [Capa geoespacial de infraestructura verde del cantón de La Unión](https://raw.githubusercontent.com/atlas-servicios-ecosistemicos-gam/datos/master/infraestructura-verde/launion/IV_LA_UNION.TIF)
```{r}

leaflet() %>%
  setView(-83.98, 9.915, 13) %>%
  ...
  addLayersControl(
    ...
    overlayGroups = c("Límite de La Unión", "Infraestructura verde"),
